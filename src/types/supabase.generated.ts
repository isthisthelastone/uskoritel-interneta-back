  ...
  public: {
    Tables: {
      ...
      user_vps_traffic_monthly_state: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_vps_traffic_monthly_state_user_internal_uuid_fkey"
            columns: ["user_internal_uuid"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["internal_uuid"]
          },
          {
            foreignKeyName: "user_vps_traffic_monthly_state_vps_internal_uuid_fkey"
            columns: ["vps_internal_uuid"]
            isOneToOne: false
      ...
      vps: {
        Row: {
          ...
          password: string
          ssh_connection_key: string | null
          ssh_key: string
          updated_at: string
          users_kv_map: Json
        }
